  ...
  data.forEach((item) => {
    ...
    $tarjeta.innerHTML = /*html*/ `
          <section class="card-front">
            ...
            <button  class="card-front__chat " type="button" name="button" data-href="${`/consola?${mandaItem(
    item
  ...
  element.innerHTML = /*html*/ `
      ...
      <section class="header">
        <p class="header__description">
          ¿Quieres conocer más sobre tus consolas de videojuegos favoritas?.. Pues ahora puedes preguntarles tu mismo!! Chatea con las diferentes consolas de cada generación.
        </p>
      </section>
    </header>
    ...
    <main>
      <section class="card">
        <div class="box-select">
          <input name="searchName" type="text" id="buscador" placeholder="Buscar consola..."/>
        </div>
        <div class="box-select">
          ...
          <button id="button_apikey" title="Introduce tu Api Key">
...
<label class= "label-hiden" for ="type"></label>
  ...
  element.addEventListener("load", () => {
    ...
    const $buttonApi = document.querySelector("#button_apikey");
    ...
    function getInfoToFilters() {
      ...
      const dataSort = data.sort(
        (a, b) => a.precioDeLanzamiento - b.precioDeLanzamiento
      );
    ...
    function showStatistics() {
      //todo lo dentro de esta funcion se activa solamente cuando se llame a la funcion
