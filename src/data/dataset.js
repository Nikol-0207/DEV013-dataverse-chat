export default [
...

  {
    ...
    description:
      "Nintendo GameCube también llamada simplemente la GameCube y abreviada como GCN en América y NGC en Japón, es la quinta consola descontinuada de sobremesa hecha por Nintendo. Fue la sucesora del Nintendo 64 y la predecesora del Wii. Su principal característica fue su procesador central basado en un IBM PowerPC (tecnología previa utilizada en computadoras personales y portátiles), y su procesador gráfico desarrollado por ATI Technologies. El nombre «GameCube» se debió a que el sistema tuvo la forma de un cubo.",
    imageUrl:
...

  {
    ...
    imageUrl:
      "https://fs-prod-cdn.nintendo-europe.com/media/images/08_content_images/systems_5/wii_12/wii_mini/whatbox_wiiconsole.png",
  ...
  },
  {
    ...
    imageUrl:
      "https://upload.wikimedia.org/wikipedia/commons/a/a1/New_Nintendo_3DS.png",
    tipo: "Consola portátil",
    precioDeLanzamiento: "$179.99 USD",
  ...
  },
  {
    ...
    description:
      "Nintendo anunció oficialmente un nuevo modelo, llamado modelo OLED. Incorpora con una pantalla OLED de 720p de 7 pulgadas (180 mm) y, cuando esté acoplado, una salida a una resolución de 1080p. Cuenta con un almacenamiento mayor que el modelo base, de 64 GB, se mejoraron las funciones de audio y se le añadió un soporte ajustable más ancho para usar en modo de mesa. La unidad se envía con una base nueva que incluye un puerto LAN con cable.",
    imageUrl:
